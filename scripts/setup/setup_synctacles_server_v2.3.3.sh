#!/usr/bin/env bash
# setup_synctacles_server_v2.3.3.sh
...
main() {
    ...
    case "$FASE" in
        ...
        fase6)
            ...
            ;;
        *)
            echo "Gebruik: sudo $0 {fase1|fase2|fase3|fase4|fase5|fase6}"
            echo
            echo "Fasen:"
            ...
            echo
            echo "Productie server: fase1 → fase2 → fase3 → fase4 → fase5"
            echo "Development:      fase1 → fase2 → fase3 → fase4 → fase6"
            echo "Beide:            fase1 → fase2 → fase3 → fase4 → fase5 → fase6"
            echo
            exit 1
            ;;
    esac
