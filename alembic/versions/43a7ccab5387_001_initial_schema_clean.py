...
def upgrade() -> None:
    ...
    op.create_table('norm_tennet_balance',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('timestamp', sa.DateTime(timezone=True), nullable=False),
    sa.Column('delta_mw', sa.Float(), nullable=False),
    ...
    op.create_table('raw_tennet_balance',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('timestamp', sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index('ix_raw_tennet_balance_platform', 'raw_tennet_balance', ['platform'], unique=False)
    op.create_index('ix_raw_tennet_balance_timestamp', 'raw_tennet_balance', ['timestamp'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('ix_raw_tennet_balance_timestamp', table_name='raw_tennet_balance')
    op.drop_index('ix_raw_tennet_balance_platform', table_name='raw_tennet_balance')
    op.drop_table('raw_tennet_balance')
    ...
    op.drop_table('norm_tennet_balance')
