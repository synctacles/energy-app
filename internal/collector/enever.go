...
// eneverResponse is the Enever API JSON structure.
type eneverResponse struct {
	Data []eneverHour `json:"data"`
}

type eneverHour struct {
	Datum    string  `json:"datum"`    // "2026-02-11"
	Uur      string  `json:"uur"`      // "00:00"
	PrijsEUR float64 // Dynamically parsed from leverancier field
}
