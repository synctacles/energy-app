...
// All features are permanently enabled — the app is fully stand-alone.
package gate

// Gate controls which features are available.
// All methods return true: every feature is always available without registration or heartbeat.
type Gate struct{}
